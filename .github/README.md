...
[`@aws-sdk/client-service-catalog-appregistry`](https://www.npmjs.com/package/@aws-sdk/client-service-catalog-appregistry/v/3.1137.0).
...
- @aws-sdk/client-service-catalog-appregistry v3.1137.0 - [https://cloud-sdk-builds.github.io/?sdk=client-service-catalog-appregistry&version=3.1137.0](https://cloud-sdk-builds.github.io/?sdk=client-service-catalog-appregistry&version=3.1137.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog-appregistry@3.1137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kGeCpj/nM+/PNlzmacaQh4MGdAHSqOmedsLbh3FSP9y3dykpwpKxxSNmZjsDc3Mt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-service-catalog-appregistry": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog-appregistry@3.1137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog-appregistry@3.1137.0/index.min.mjs": "sha384-kGeCpj/nM+/PNlzmacaQh4MGdAHSqOmedsLbh3FSP9y3dykpwpKxxSNmZjsDc3Mt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-service-catalog-appregistry/blob/refs/tags/3.1137.0/LICENSE
```
